...
Solicito que o desenvolvimento utilize o modelo gemini-3.8-flash-high, configurado com o nível máximo de esforço de raciocínio disponível.
...
1. Se o modelo gemini-3.8-flash-high está efetivamente disponível no ambiente.
...
Não declare que um agente utilizou gemini-3.8-flash-high sem confirmação de que esse modelo foi efetivamente selecionado.
...
Configure os agentes para utilizar gemini-3.8-flash-high com o esforço máximo de raciocínio, se essa combinação estiver efetivamente disponível no ambiente.
...
Utilize gemini-3.8-flash-high com esforço máximo quando essa configuração estiver disponível; caso contrário, utilize a maior capacidade efetivamente suportada.
